# Manage generation/validation of URLs generated by the present app and linking to itself
...
def generate_scan_url(project_hash: str, sample_hash: str, subsample_hash: str) -> str:
    ...
    """
    return f"/api/projects/{project_hash}/samples/{sample_hash}/subsamples/{subsample_hash}/{SCAN_JPEG}"
...
def generate_background_url(project_hash: str, background_date: str) -> str:
    ...
    """
    return f"/api/projects/{project_hash}/background/{background_date}.jpg"
...
def generate_work_image_url(
    ...
    return f"/api/projects/{project_hash}/samples/{sample_hash}/subsamples/{subsample_hash}/{subdir}{image_name}"
