...
def separate_img(path,filename,path_out, taskId):
    ...
    if response.ok:
        ...
        requests.put(url=f"${dbserver}/separator/{taskId}", data=data)
...
def separate_images(path, path_out, path_result, taskId):
    ...
    for file in files: 
        ...
        name = decompose[1]
        mask_img = separate_img(path, name, path_out, taskId)
        print("mask: ", mask_img)
