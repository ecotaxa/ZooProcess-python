...
from src.separate_fn import separate_images , separate_apply_mask
...
class Test_separate(unittest.TestCase):
    ...
    def test_image_to_public(self):
        ...
        images = separate_images(path=path, path_out=zooscan_mask_folder, path_result=dest, taskId=None)
